...
class Common_Config(object):
    def __init__(self):
        self.ion_terms = {'b{}':'n','y{}':'c','c{}':'n','z{}':'c','b{}-ModLoss':'n','y{}-ModLoss':'c','b{}-H2O':'n','y{}-H2O':'c','b{}-NH3':'n','y{}-NH3':'c', 'internal{}':'n'}
...
class HCD_CommonMod_Config(Common_Config):
    def __init__(self):
        ...
        self.varmod = ['Gln->pyro-Glu[AnyN-termQ]', 'Deamidated[N]', 'Deamidated[Q]', 'Oxidation[M]', 'Acetyl[AnyN-term]', 'Carbamyl[AnyN-term]', 'Carbamidomethyl[C]']
        self.min_var_mod_num = 0
        self.max_var_mod_num = 15
